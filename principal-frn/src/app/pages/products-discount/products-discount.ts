...
@Component({
  ...
  imports: [CategoriesList, ProductMenu],
  templateUrl: './products-discount.html',
  styleUrl: './products-discount.css'
})
export class ProductsDiscount {
  private request = inject(RequestForm);

  constructor(private cdRef: ChangeDetectorRef, private route: Router) {}

  barContainer:   any;
  titlemenu:      string = "Descontos";
