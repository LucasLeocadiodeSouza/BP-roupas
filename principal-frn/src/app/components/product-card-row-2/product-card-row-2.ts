...
import { MiniCard2 } from "../mini-card-2/mini-card-2";

@Component({
  selector: 'app-product-card-row-2',
  imports: [CommonModule, MiniCard2],
  templateUrl: './product-card-row-2.html',
  styleUrl: './product-card-row-2.css'
})
export class ProductCardRow2 implements AfterViewInit   {
  @Input() title: any;
  @Input() extclass: any;
  @Input() miniCards: any;
